...
const ReSubmittedNotes = () => {
    ...
    const fetchDetailsMain = async () => {
        setLoading(true);
        try {
            const response = await axiosInstance.get(`${config.API_URL}/Product/GetProductListForReSubmit`, {
                            ...
                            <div className='bg-white p-2 pb-2'>
                                <Row >
                                    <div className="d-flex justify-content-between profilebar p-1">
                                        <h4 className='text-primary d-flex align-items-center m-0'><i className="ri-file-list-line me-2 text-primary "></i> Re Submitted Notes </h4>
...
export default ReSubmittedNotes;